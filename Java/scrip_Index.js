// Erstelle eine Karte mit Leaflet
var map = L.map('map').setView([48.2082, 16.3738], 13);
var Wetter = document.getElementById('wetter');

// Füge den OpenStreetMap-Tiles hinzu
...
var myLayer = L.geoJSON.ajax("https://data.wien.gv.at/daten/geo?service=WFS&request=GetFeature&version=1.1.0&typeName=ogdwien:BURGSCHLOSSOGD&srsName=EPSG:4326&outputFormat=json", {
    onEachFeature: function(feature, layer) {
        var name = feature.properties.NAME;
        var description = feature.properties.BESCHREIBUNG;
        layer.bindPopup("<b>" + name + "</b><br>" + description);
    }
}).addTo(map);
var myLayer = L.geoJSON.ajax("https://data.wien.gv.at/daten/geo?service=WFS&request=GetFeature&version=1.1.0&typeName=ogdwien:SPAZIERPUNKTOGD%20&srsName=EPSG:4326&outputFormat=json", {
    onEachFeature: function(feature, layer) {
        var name2 = feature.properties.NAME;
        var description2 = feature.properties.BEMERKUNG;
        layer.bindPopup("<b>" + name2 + "</b><br>" + description2);
    }
}).addTo(map);
...
Meteogram.prototype.getChartOptions = function () {
  return {
    ...
    title: {
      text: 'Wetter für Wien, Österreich',
      align: 'left',
      style: {
        whiteSpace: 'nowrap',
...
if (!location.hash) {
  location.hash = 'https://api.met.no/weatherapi/locationforecast/2.0/compact?lat=48.50853&lon=16.12574&altitude=2';
}
